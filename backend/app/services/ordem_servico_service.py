...
class OrdemServicoService:
    ...
    @staticmethod
    def enviar_confirmacao_ordem_servico(telefone: str, cliente_nome: str, veiculo_placa: str, 
    ...
    @staticmethod
    def enviar_lembrete_ordem_servico(telefone: str, cliente_nome: str, data_hora: str, servico: str) -> Dict[str, Any]:
        mensagem = MensagemTemplates.lembrete_ordem_servico(
            cliente_nome=cliente_nome,
            data_hora=data_hora,
            servico=servico
        )
